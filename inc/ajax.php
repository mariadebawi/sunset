...
function sunset_load_more()
{
  ...
  if ($archive != '0') {
    ...
    $archVal = explode('/', $archive); // explode ==> remove char 

    if (in_array("category", $archVal)) { //check category
      $type = "category_name";
    ...
    if (in_array("tag", $archVal)) { //check category
      $type = "tag";
    ...
    if (in_array("author", $archVal)) { //check category
      $type = "author";
